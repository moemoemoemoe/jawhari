                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-6 summary-before">
                        ...
                        <div class="product-slider images">
                            <ul class="slides">
                                <li data-thumb="{{asset('uploads/articles/'.$article->image_url_original)}}">
                                    <a href="{{asset('uploads/articles/'.$article->image_url_original)}}" data-imagelightbox="gallery" class="poster_2_up">
                                        <img src="{{asset('uploads/articles/'.$article->image_url_original)}}" alt="Single">
                                    </a>
                                </li>
                    ...
                    <div class="col-sm-6 col-md-7 col-lg-7 product-review entry-summary" style="direction: rtl">
                        ...
                        <h1 itemprop="name" class="product_title entry-title">{{$article->title}}</h1>
