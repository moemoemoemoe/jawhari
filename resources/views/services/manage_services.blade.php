...
@foreach($services as $article)
    <div class="col-md-3">
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="height:150px ; background: url('{{asset('uploads/services/'.$article->image_url_original)}}'); background-size: cover; background-position: center center;background-repeat: no-repeat;">
                
            </div>
            <div class="panel-footer text-center">
                <a href="{{route('delete_service', $article->id)}}" class="btn btn-danger form-control">Delete</a>
            </div>
        </div>
    </div>
